AddDamageType("GCats_FNP45SD",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_FNP45SD> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_FNP45SD> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_FNP45SDItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./FNP45/FNP45SD.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "SW: FNP 45 SD";
	iconName = "./Icons/icon_FNP45SD";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_FNP45SDImage;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_FNP45SDImage)
{
   // Basic Item properties
	shapeFile = "./FNP45/FNP45SD.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = GCats_FNP45SDSafetyImage;
    scopingImage = GCats_FNP45SDIronsightImage;
	doColorShift = true;
	colorShiftColor = GCats_FNP45SDItem.colorShiftColor;//"0.400 0.196 0 1.000";
    ...
    directDamageType = $DamageType::GCats_FNP45SD;
    directHeadDamageType = $DamageType::GCats_FNP45SD;
...
function GCats_FNP45SDImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
...
function GCats_FNP45SDImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}

function GCats_FNP45SDImage::onReloadEnd(%this,%obj,%slot)
{
...
function GCats_FNP45SDImage::onReloadStart(%this,%obj,%slot)
{
   %obj.aeplayThread(2, shiftRight);
}

function GCats_FNP45SDImage::onReady(%this,%obj,%slot)
{
...
function GCats_FNP45SDImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_FNP45SDImage::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(GCats_FNP45SDIronsightImage : GCats_FNP45SDImage)
{
	recoilHeight = 0.1625;

	scopingImage = GCats_FNP45SDImage;
	sourceImage = GCats_FNP45SDImage;
...
function GCats_FNP45SDIronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_FNP45SDIronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_FNP45SDIronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
  %obj.playAudio(0, GCats_SDFireSound);
...
function GCats_FNP45SDIronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_FNP45SDIronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_FNP45SDIronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
