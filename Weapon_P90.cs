datablock AudioProfile(GCats_P90FireSound)
{
   filename    = "./Sounds/P90.wav";
   description = MediumClose3D;
   preload = true;
};

AddDamageType("GCats_P90",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_P90> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_P90> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_P90Item)
{
	...
	//gui stuff
	uiName = "SW: P90";
	iconName = "./Icons/icon_P90";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_P90Image;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_P90Image)
{
   // Basic Item properties
	shapeFile = "./P90/P90.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = GCats_P90SafetyImage;
    scopingImage = GCats_P90IronsightImage;
	doColorShift = true;
	colorShiftColor = GCats_P90Item.colorShiftColor;//"0.400 0.196 0 1.000";
    ...
    directDamageType = $DamageType::GCats_P90;
    directHeadDamageType = $DamageType::GCats_P90;
...
function GCats_P90Image::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
    %obj.playAudio(0, GCats_P90FireSound);
...
function GCats_P90Image::onReloadEnd(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function GCats_P90Image::onDryFire(%this, %obj, %slot)
{
...
function GCats_P90Image::onReloadStart(%this,%obj,%slot)
{
   %obj.aeplayThread(2, shiftRight);
}

function GCats_P90Image::onReady(%this,%obj,%slot)
{
...
function GCats_P90Image::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_P90Image::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(GCats_P90IronsightImage : GCats_P90Image)
{
	recoilHeight = 0.0625;

	scopingImage = GCats_P90Image;
	sourceImage = GCats_P90Image;
...
function GCats_P90IronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_P90IronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_P90IronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
    %obj.playAudio(0, GCats_P90FireSound);
...
function GCats_P90IronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_P90IronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_P90IronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
