AddDamageType("GCats_L85A2SD",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_L85A2SD> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_L85A2SD> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_L85A2SDItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./L85A2/L85A2SD.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "SW: L85A2SD";
	iconName = "./Icons/icon_L85A2SD";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_L85A2SDImage;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_L85A2SDImage)
{
   // Basic Item properties
	shapeFile = "./L85A2/L85A2SD.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = GCats_L85A2SDSafetyImage;
    scopingImage = GCats_L85A2SDIronsightImage;
	doColorShift = true;
	colorShiftColor = GCats_L85A2SDItem.colorShiftColor;//"0.400 0.196 0 1.000";
    ...
    directDamageType = $DamageType::GCats_L85A2SD;
    directHeadDamageType = $DamageType::GCats_L85A2SD;
...
function GCats_L85A2SDImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
...
function GCats_L85A2SDImage::onReloadEnd(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function GCats_L85A2SDImage::onDryFire(%this, %obj, %slot)
{
...
function GCats_L85A2SDImage::onReloadStart(%this,%obj,%slot)
{
   %obj.aeplayThread(2, shiftRight);
}

function GCats_L85A2SDImage::onReady(%this,%obj,%slot)
{
...
function GCats_L85A2SDImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_L85A2SDImage::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(GCats_L85A2SDIronsightImage : GCats_L85A2SDImage)
{
	recoilHeight = 0.0625;

	scopingImage = GCats_L85A2SDImage;
	sourceImage = GCats_L85A2SDImage;
...
function GCats_L85A2SDIronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_L85A2SDIronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_L85A2SDIronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
    %obj.playAudio(0, GCats_SDFireSound);
...
function GCats_L85A2SDIronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_L85A2SDIronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_L85A2SDIronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
