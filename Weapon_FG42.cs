datablock AudioProfile(GCats_FG42FireSound)
{
   filename    = "./Sounds/FG42.wav";
   description = MediumClose3D;
   preload = true;
};

AddDamageType("GCats_FG42",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_FG42> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_FG42> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_FG42Item)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./FG42/FG42.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "SW: FG42";
	iconName = "./Icons/icon_fg42";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_FG42Image;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_FG42Image)
{
   // Basic Item properties
	shapeFile = "./FG42/FG42.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = GCats_FG42SafetyImage;
    scopingImage = GCats_FG42IronsightImage;
	doColorShift = true;
	colorShiftColor = GCats_FG42Item.colorShiftColor;//"0.400 0.196 0 1.000";
    ...
    directDamageType = $DamageType::GCats_FG42;
    directHeadDamageType = $DamageType::GCats_FG42;
...
function GCats_FG42Image::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
    %obj.playAudio(0, GCats_FG42FireSound);
...
function GCats_FG42Image::onReloadEnd(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function GCats_FG42Image::onDryFire(%this, %obj, %slot)
{
...
function GCats_FG42Image::onReloadStart(%this,%obj,%slot)
{
   %obj.aeplayThread(2, shiftRight);
}

function GCats_FG42Image::onReady(%this,%obj,%slot)
{
...
function GCats_FG42Image::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_FG42Image::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(GCats_FG42IronsightImage : GCats_FG42Image)
{
	recoilHeight = 0.0625;

	scopingImage = GCats_FG42Image;
	sourceImage = GCats_FG42Image;
	
	isScopedImage = true;
	
	offset = "0 0 0";
	eyeOffset = "0 0.18 -0.501";
...
function GCats_FG42IronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_FG42IronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_FG42IronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
    %obj.playAudio(0, GCats_FG42FireSound);
...
function GCats_FG42IronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_FG42IronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_FG42IronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
