AddDamageType("GCats_AKS74uSD",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_AKS74uSD> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_AKS74uSD> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_AKS74uSDItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./AKS74u/AKS74uSD.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "SW: AKS74u SD";
	iconName = "./Icons/icon_AKS74uSD";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_AKS74uSDImage;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_AKS74uSDImage)
{
   // Basic Item properties
	shapeFile = "./AKS74u/AKS74uSD.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = GCats_AKS74uSDSafetyImage;
    scopingImage = GCats_AKS74uSDIronsightImage;
	doColorShift = true;
	colorShiftColor = GCats_AKS74uSDItem.colorShiftColor;//"0.400 0.196 0 1.000";
    ...
    directDamageType = $DamageType::GCats_AKS74uSD;
    directHeadDamageType = $DamageType::GCats_AKS74uSD;
...
function GCats_AKS74uSDImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
...
function GCats_AKS74uSDImage::onReloadEnd(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function GCats_AKS74uSDImage::onDryFire(%this, %obj, %slot)
{
...
function GCats_AKS74uSDImage::onReloadStart(%this,%obj,%slot)
{
   %obj.aeplayThread(2, shiftRight);
}

function GCats_AKS74uSDImage::onReady(%this,%obj,%slot)
{
...
function GCats_AKS74uSDImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_AKS74uSDImage::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(GCats_AKS74uSDIronsightImage : GCats_AKS74uSDImage)
{
	recoilHeight = 0.0625;

	scopingImage = GCats_AKS74uSDImage;
	sourceImage = GCats_AKS74uSDImage;
...
function GCats_AKS74uSDIronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_AKS74uSDIronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_AKS74uSDIronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
    %obj.playAudio(0, GCats_SDFireSound);
...
function GCats_AKS74uSDIronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_AKS74uSDIronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_AKS74uSDIronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
