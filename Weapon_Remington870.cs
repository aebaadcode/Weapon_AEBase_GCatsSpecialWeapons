datablock AudioProfile(GCats_R870FireSound)
{
   filename    = "./Sounds/r870.wav";
   description = HeavyClose3D;
   preload = true;
};

datablock AudioProfile(GCats_R870PumpSound)	
{
   filename    = "./Sounds/r870pump.wav";
   description = AudioClose3d;
   preload = true;
};

datablock AudioProfile(GCats_R870ReloadSound)	
{
   filename    = "./Sounds/r870reload.wav";
   description = AudioClose3d;
   preload = true;
};

AddDamageType("GCats_R870",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_R870> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_R870> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_R870Item)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./R870/R870.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "SW: R870";
	iconName = "./Icons/icon_r870";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_R870Image;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_R870Image)
{
   // Basic Item properties
	shapeFile = "./R870/R870.dts";
   emap = true;
   ...
   armReady = true;
   safetyImage = GCats_R870SafetyImage;
   scopingImage = GCats_R870IronsightImage;
   doColorShift = true;
   colorShiftColor = GCats_R870Item.colorShiftColor;
...
//   shellSoundMax = 550; //max delay for when the shell sound plays
    ...
    directDamageType = $DamageType::GCats_R870;
    directHeadDamageType = $DamageType::GCats_R870;
...
function GCats_R870Image::AEOnFire(%this,%obj,%slot)
{
...
function GCats_R870Image::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}

function GCats_R870Image::onReady(%this,%obj,%slot)
{
...
function GCats_R870Image::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
	parent::onMount(%this,%obj,%slot);
}

function GCats_R870Image::onUnMount(%this, %obj, %slot)
{	
...
function GCats_R870Image::LoadEffect(%this,%obj,%slot)
{
...
function GCats_R870Image::AEShotgunLoadOneEffectless(%this,%obj,%slot)
{
	Parent::AEShotgunLoadOne(%this, %obj, %slot);
}

function GCats_R870Image::onPump(%this,%obj,%slot)
{
	schedule(300, 0, serverPlay3D, AEShellShotgun @ getRandom(1,2) @ Sound, %obj.getPosition());
	serverPlay3D(GCats_R870PumpSound,%obj.getPosition());	
}

datablock ShapeBaseImageData(GCats_R870IronsightImage : GCats_R870Image)
{
	recoilHeight = 0.5;

	scopingImage = GCats_R870Image;
	sourceImage = GCats_R870Image;
	
    offset = "0 0 0";
	eyeOffset = "0 0.05 -0.245";
...
function GCats_R870IronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_R870IronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_R870IronsightImage::AEOnFire(%this,%obj,%slot)
{
	%obj.blockImageDismount = true;
	%obj.schedule(750, unBlockImageDismount);
...
function GCats_R870IronsightImage::onPump(%this,%obj,%slot)
{
	schedule(500, 0, serverPlay3D, AEShellShotgun @ getRandom(1,2) @ Sound, %obj.getPosition());
	serverPlay3D(GCats_R870PumpSound,%obj.getPosition());	
}

function GCats_R870IronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_R870IronsightImage::onMount(%this,%obj,%slot)
{
...
function GCats_R870IronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
