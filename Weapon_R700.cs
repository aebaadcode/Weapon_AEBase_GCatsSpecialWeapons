datablock AudioProfile(GCats_R700FireSound)
{
   filename    = "./Sounds/R700.wav";
   description = MediumClose3D;
   preload = true;
};

datablock AudioProfile(GCats_R700BoltSound)	
{
   filename    = "./Sounds/R700bolt.wav";
   description = AudioClose3d;
   preload = true;
};

datablock AudioProfile(GCats_R700ReloadSound)	
{
   filename    = "./Sounds/R700reload.wav";
   description = AudioClose3d;
   preload = true;
};

AddDamageType("GCats_R700",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_R700> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_R700> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_R700Item)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./R700/R700.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "SW: R700";
	iconName = "./Icons/icon_R700";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_R700Image;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_R700Image)
{
   // Basic Item properties
	shapeFile = "./R700/R700.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = GCats_R700SafetyImage;
    scopingImage = GCats_R700IronsightImage;
	doColorShift = true;
	colorShiftColor = GCats_R700Item.colorShiftColor;//"0.400 0.196 0 1.000";
    ...
    directDamageType = $DamageType::GCats_R700;
    directHeadDamageType = $DamageType::GCats_R700;
...
function GCats_R700Image::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
  %obj.playAudio(0, GCats_R700FireSound);
...
function GCats_R700Image::onBolt(%this,%obj,%slot)
{
...
function GCats_R700Image::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}

function GCats_R700Image::onReloadEnd(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function GCats_R700Image::onReloadEnd2(%this,%obj,%slot)
{
	schedule(300, 0, serverPlay3D, AEShellRifle @ getRandom(1,2) @ Sound, %obj.getPosition());
	serverPlay3D(GCats_R700BoltSound,%obj.getPosition());	
	%obj.aeplayThread(2, plant);
...
function GCats_R700Image::LoadEffect(%this,%obj,%slot)
{
...
function GCats_R700Image::onReloadStart(%this,%obj,%slot)
{
   %obj.aeplayThread(2, shiftRight);
}

function GCats_R700Image::onReady(%this,%obj,%slot)
{
...
function GCats_R700Image::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_R700Image::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(GCats_R700IronsightImage : GCats_R700Image)
{
	recoilHeight = 0.1625;

	scopingImage = GCats_R700Image;
	sourceImage = GCats_R700Image;
...
function GCats_R700IronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_R700IronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_R700IronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
  %obj.playAudio(0, GCats_R700FireSound);
...
function GCats_R700IronsightImage::onBolt(%this,%obj,%slot)
{
	schedule(300, 0, serverPlay3D, AEShellRifle @ getRandom(1,2) @ Sound, %obj.getPosition());
	serverPlay3D(GCats_R700BoltSound,%obj.getPosition());	
}
...
function GCats_R700IronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_R700IronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_R700IronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
