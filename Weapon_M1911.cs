datablock AudioProfile(GCats_M1911FireSound)
{
   filename    = "./Sounds/M1911.wav";
   description = LightClose3D;
   preload = true;
};

AddDamageType("GCats_M1911",'<bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_M1911> %1','%2 <bitmap:Add-ons/Weapon_AEBase_GCatsSpecialWeapons/Icons/CI_M1911> %1',0.2,1);

//////////
// item //
//////////
datablock ItemData(GCats_M1911Item)
{
	...
	//gui stuff
	uiName = "SW: M1911";
	iconName = "./Icons/icon_M1911";
	doColorShift = true;
	colorShiftColor = "1 1 1 1";

	 // Dynamic properties defined by the scripts
	image = GCats_M1911Image;
	canDrop = true;
	...
	recoil = "Medium"; 
	uiColor = "1 1 1";
	description = "The M1911 is a semi-automatic, single-action-only pistol that operates off of a short recoil system.";
...
//weapon image//
////////////////
datablock ShapeBaseImageData(GCats_M1911Image)
{
   // Basic Item properties
	shapeFile = "./M1911/M1911.dts";
   emap = true;
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = false;
	safetyImage = GCats_M1911SafetyImage;
    scopingImage = GCats_M1911IronsightImage;
	doColorShift = true;
	colorShiftColor = GCats_M1911Item.colorShiftColor;//"0.400 0.196 0 1.000";
    ...
    directDamageType = $DamageType::GCats_M1911;
    directHeadDamageType = $DamageType::GCats_M1911;
...
function GCats_M1911Image::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
  %obj.playAudio(0, GCats_M1911FireSound);
...
function GCats_M1911Image::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}

function GCats_M1911Image::onReloadEnd(%this,%obj,%slot)
{
...
function GCats_M1911Image::onReloadStart(%this,%obj,%slot)
{
   %obj.aeplayThread(2, shiftRight);
}

function GCats_M1911Image::onReady(%this,%obj,%slot)
{
...
function GCats_M1911Image::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_M1911Image::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(GCats_M1911IronsightImage : GCats_M1911Image)
{
	recoilHeight = 0.3125;

	scopingImage = GCats_M1911Image;
	sourceImage = GCats_M1911Image;
...
function GCats_M1911IronsightImage::onDone(%this,%obj,%slot)
{
	%obj.reloadTime[%this.sourceImage.getID()] = getSimTime();
	%obj.mountImage(%this.sourceImage, 0);
}

function GCats_M1911IronsightImage::onReady(%this,%obj,%slot)
{
	%obj.baadDisplayAmmo(%this);
}

function GCats_M1911IronsightImage::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(0); 
  %obj.playAudio(0, GCats_M1911FireSound);
...
function GCats_M1911IronsightImage::onDryFire(%this, %obj, %slot)
{
	serverPlay3D(GCats_EmptySound, %obj.getHackPosition());
}
...
function GCats_M1911IronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function GCats_M1911IronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
